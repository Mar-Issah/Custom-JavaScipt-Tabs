...
A simple and creative tab navigation built with HTML5,  CSS3 and JavaScript.
...
1. Clone the repo on your local machine.
   ```sh
   git clone https://github.com/Mar-Issah/Custom-JavaScipt-Tabs.git
   ```
...
## Project View
[Click here](https://codepen.io/marsiya-issah/full/abpwRPx) to view project on CodePen.
